				...
				<div class="col-lg-8">
					<div class="contact-right">
						<div class="section-title">
							<h3>Get in touch</h3>
							<p>Browse properties for sale, rent and joint ventures</p>
						</div>
						...
						@endif
						<form class="contact-form" action="/contact/send" id="contact" method="POST">
							@csrf
							<div class="row">
								<div class="col-md-6">
								...
								<button class="btn site-btn" type="submit">More</button>
							</div>
						</form>
					</div>
				</div>
