...
@section('content')
	...
	<div class="site-breadcrumb">
		<div class="container">
			...
			<span><i class="fa fa-angle-right"></i>Sales Listings</span>
		</div>
	</div>
					...
					<div class="feature-item">
						...
						<div class="feature-text">
							...
							<div class="room-info-warp">
								<div class="room-info">
									<div class="rf-left">
										<p><i class="fa fa-bed"></i> {{ $sale->bedrooms }} Bedrooms</p>
									</div>
									<div class="rf-right">
								...
								<div class="room-info">
									...
									<div class="rf-left">
										<p><i class="fa fa-clock-o"></i> {{ \Carbon\Carbon::parse($sale->created_at)->format('d/m/Y') }}</p>
									</div>	
								</div>
								<div class="room-info">
											...
											<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
												<div class="modal-dialog">
													<div class="modal-content">
														...
														<form method="post"  action="/listings/send">
															{{ csrf_field() }}
																<h4 class="text-center">Request now</h4>
														<div class="modal-body">
															<div class="form-group">
															<input name="propaddress" class="form-control-req" value="{{ $sale->address }}" readonly>
															<input name="propprice" class="form-control-req" value="# {{number_format($sale->price, 2)}}" readonly>
															<input name="propdesc" class="form-control-req" value="{{ $sale->description }}" readonly>
															<input name="proplocation" class="form-control-req" value="{{ $sale->city }}" readonly>
															</div>
														</div>
							...
							<a href="{{ url('/listingsdetails',$sale->id) }}" class="room-price"># {{number_format($sale->price, 2)}}</a>
						</div>
					</div>
				</div>
				@endforeach
